...
innerhtml()
function innerhtml(){
textsalary.innerHTML = "Salary: "+ ssalary+ " Лв" + " &nbsp&nbsp&nbsp&nbsp &nbsp&nbsp&nbsp &nbspBills: "+ bbills+ " Лв" +"&nbsp &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp  Amount to spend: "+ monthly+ " Лв"
mosp.innerHTML = parseFloat(motosp).toFixed(2) + " Лв"
mosa.innerHTML = parseFloat(motosa).toFixed(2) + " Лв"
tusp.innerHTML = parseFloat(tutosp).toFixed(2) + " Лв"
tusa.innerHTML = parseFloat(tutosa).toFixed(2) + " Лв"
wesp.innerHTML = parseFloat(wetosp).toFixed(2) + " Лв"
wesa.innerHTML = parseFloat(wetosa).toFixed(2) + " Лв"
thsp.innerHTML = parseFloat(thtosp).toFixed(2) + " Лв"
thsa.innerHTML = parseFloat(thtosa).toFixed(2) + " Лв"
frsp.innerHTML = parseFloat(frtosp).toFixed(2) + " Лв"
frsa.innerHTML = parseFloat(frtosa).toFixed(2) + " Лв"
sasp.innerHTML = parseFloat(satosp).toFixed(2) + " Лв"
sasa.innerHTML = parseFloat(satosa).toFixed(2) + " Лв"
susp.innerHTML = parseFloat(sutosp).toFixed(2) + " Лв"
susa.innerHTML = parseFloat(sutosa).toFixed(2) + " Лв"
moto.innerHTML = "Total: " + daily + " Лв"
tuto.innerHTML = "Total: " + daily + " Лв"
weto.innerHTML = "Total: " + daily + " Лв"
thto.innerHTML = "Total: " + daily + " Лв"
frto.innerHTML = "Total: " + daily + " Лв"
sato.innerHTML = "Total: " + daily + " Лв"
suto.innerHTML = "Total: " + daily + " Лв"
totalmospm.innerHTML = parseFloat(monthlysp).toFixed(2) + " Лв"
totalmosam.innerHTML = parseFloat(monthlysa).toFixed(2) + " Лв"
totalmospy.innerHTML = parseFloat(totalspending).toFixed(2) + " Лв"
totalmosay.innerHTML = parseFloat(totalsaving).toFixed(2) + " Лв"
...
function mof2(){
   ...
   mosp.innerHTML = motosp.toFixed(2) + " Лв"
   motosa = daily - motosp
   mosa.innerHTML = motosa.toFixed(2) + " Лв";
...
function tuf2(){
   ...
   tusp.innerHTML = tutosp.toFixed(2) + " Лв"
   tutosa = daily - tutosp
   tusa.innerHTML = tutosa.toFixed(2) + " Лв"
...
function wef2(){
   ...
   wesp.innerHTML = wetosp.toFixed(2) + " Лв"
   wetosa = daily - wetosp
   wesa.innerHTML = wetosa.toFixed(2) + " Лв"
...
function thf2(){
   ...
   thsp.innerHTML = thtosp.toFixed(2) + " Лв"
   thtosa = daily - thtosp
   thsa.innerHTML = thtosa.toFixed(2) + " Лв"
...
function frf2(){
   ...
   frsp.innerHTML = frtosp.toFixed(2) + " Лв"
   frtosa = daily - frtosp
   frsa.innerHTML = frtosa.toFixed(2) + " Лв"
...
function saf2(){
   ...
   sasp.innerHTML = satosp.toFixed(2) + " Лв"
   satosa = daily - satosp
   sasa.innerHTML = satosa.toFixed(2) + " Лв"
...
function suf2(){
   ...
   susp.innerHTML = sutosp.toFixed(2) + " Лв"
   sutosa = daily - sutosp
   susa.innerHTML = sutosa.toFixed(2) + " Лв"
...
function weekday(){
    var d = new Date();
 var n = d.getDay();
 if(n == 0){sunday.classList.add("active");
saturday.classList.remove("active")} 
else if(n == 1){monday.classList.add("active");
sunday.classList.remove("active")}
else if(n == 2){tuesday.classList.add("active");
monday.classList.remove("active")}
else if(n == 3){wednesday.classList.add("active");
tuesday.classList.remove("active")}
else if(n == 4){thursday.classList.add("active");
wednesday.classList.remove("active")}
else if(n == 5){friday.classList.add("active");
thursday.classList.remove("active")}
else if(n == 6){saturday.classList.add("active");
...
totalmospw.innerHTML = weeklysp.toFixed(2) + " Лв"
...
totalmosaw.innerHTML = weeklysa.toFixed(2) + " Лв"
var key = "weeklysp"
var key1 = "weeklysa"
...
weeklysa = 0
weeklysp = 0
totalmospm.innerHTML = monthlysp.toFixed(2) + " Лв"
totalmosam.innerHTML = monthlysa.toFixed(2) + " Лв"
ls.setItem("weeklysp",weeklysp)
ls.setItem("weeklysa",weeklysa)

totalmospw.innerHTML = weeklysp + " Лв"
totalmosaw.innerHTML = weeklysa + " Лв"
motosp = 0
tutosp = 0
wetosp = 0
thtosp = 0
...
moto.innerHTML = "Total: " + monthly + " Лв"
    tuto.innerHTML = "Total: " + monthly + " Лв"
    weto.innerHTML = "Total: " + monthly + " Лв"
    thto.innerHTML = "Total: " + monthly + " Лв"
    frto.innerHTML = "Total: " + monthly + " Лв"
    sato.innerHTML = "Total: " + monthly + " Лв"
    suto.innerHTML = "Total: " + monthly + " Лв"
totalmospy.innerHTML = parseFloat(totalspending).toFixed(2) + " Лв"
totalmosay.innerHTML = parseFloat(totalsaving).toFixed(2) + " Лв"
...
function clearAll(){
    ...
    if (yes=="yes"){
        alert("you have deleted the local storage, refresh the page to see the changes")
        ls.clear()
    }
}